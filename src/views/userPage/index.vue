  ...
  <div>
    ...
    >
      <el-table-column
          ...
          width="50"
      />
      <el-table-column prop="id" header-align="center" align="center" label='id' min-width="170" />
      <el-table-column prop="userName" header-align="center" align="center" label='用户名' min-width="170" />
